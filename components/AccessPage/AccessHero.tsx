...
export default function AccessForm() {
  ...
  return (
    <div className="flex items-start justify-center w-full py-6 sm:py-8 md:py-10 bg-white">
      <form
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          <label className="block text-[13px] flex-1">
            ...
            <input
              ...
              className="w-full h-[47px] px-3 border rounded-md focus:ring-2 focus:ring-blue-500 font-semibold text-sm"
            />
          </label>
